...
describe(dataset)
summary(dataset)
#Transformo los puntajes en variables categoricas
...
#Quito los missings solamente para el analisis de outliers
...
#Analizo frecuencias de las variables categoricas
...
#Relacion entre entretenimiento y edad
...
#Relacion entre la clase y el tipo de viaje
...
#Relacion entre la satisfaccion y la clase
...
#Relacion entre Departure Delay in Minutes y Arrival Delay in Minutes
...
#Relacion entre la clase y distancia de vuelo
